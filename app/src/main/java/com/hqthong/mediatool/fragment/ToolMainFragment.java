...
public class ToolMainFragment extends DefaultTemplateFragment {
    View parent;


    public static ToolMainFragment newInstance() {
        ToolMainFragment fragmentFirst = new ToolMainFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        parent = inflater.inflate(R.layout.fm_tool_main, container, false);
