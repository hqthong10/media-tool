...
public class ImageMainFragment extends DefaultTemplateFragment {
    View parent;


    public static ImageMainFragment newInstance() {
        ImageMainFragment fragmentFirst = new ImageMainFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        parent = inflater.inflate(R.layout.fm_image_main, container, false);
