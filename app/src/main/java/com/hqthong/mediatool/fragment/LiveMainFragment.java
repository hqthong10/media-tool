...
public class LiveMainFragment extends DefaultTemplateFragment {
    View parent;


    public static LiveMainFragment newInstance() {
        LiveMainFragment fragmentFirst = new LiveMainFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        parent = inflater.inflate(R.layout.fm_live_main, container, false);
